...
public class Grenade  implements Ammo {
    ...
    public Grenade(Vector position, Vector velocity, int damage, Vector gravity){
    ...
    public void render(Graphics g,Assets assets){
        ...
        g2.drawImage(assets.grenade, 0,0, length,10,null);
